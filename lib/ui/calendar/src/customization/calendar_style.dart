...
class CalendarStyle {
  ...
  const CalendarStyle({
    ...
    this.holidayStyle = const TextStyle(color:  Color(0xFFF44336)), // Material red[500]
    this.selectedStyle = const TextStyle(color:  Colors.black, fontSize: 16.0), // Material grey[50]
    this.todayStyle = const TextStyle(color:  Colors.black, fontSize: 16.0), // Material grey[50]
    ...
    this.markersColor = Colors.red, // Material blueGrey[900]
